        ...
        <div className="space-y-8 text-sm leading-relaxed text-neutral-700">
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc pl-5">
              ...
              <li>"팀장"이란 근로자 팀을 결성하여 기업 담당자에게 팀 단위로 지원할 수 있는 회원을 의미합니다.</li>
              <li>"기업 담당자"란 건설 현장 인력 채용을 목적으로 서비스를 이용하는 기업 또는 개인 회원을 의미합니다.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc pl-5">
              ...
              <li>기업 담당자-근로자/팀 간 채팅 및 제안 서비스</li>
          ...
          <section>
            ...
            <p className="mb-2">
              서비스 내 일부 기능(예: 기업 담당자의 팀장 채팅 개설, 팀장의 팀원 채팅 개설)은 포인트를 소모합니다. 포인트 관련 세부 사항은 다음과 같습니다:
            </p>
            <ul className="space-y-2 list-disc pl-5">
