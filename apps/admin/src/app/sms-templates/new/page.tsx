...
import { createSmsTemplate } from "@/lib/api";
  ...
  return (
    <AdminLayout breadcrumbs={breadcrumbs}>
      <div className="max-w-2xl space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-neutral-950">새 SMS 템플릿</h1>
          <p className="mt-1 text-sm text-neutral-500">새로운 SMS 발송 템플릿을 등록합니다.</p>
        </div>
